...
def build_facts_extraction_prompt(
    *,
    ...
    lines = [
        ...
        "要求：",
        "- 必须返回 `FactExtractionResult` 顶层 JSON 对象，不能只返回裸 `ExtractedFacts`",
        "- 顶层必须包含这些字段：merged_facts、open_questions、newly_confirmed_fields、conflicts、reasoning_summary",
        ...
        "最小 JSON 示例：",
        '{"merged_facts":{"goal":null,"users":[],"scenarios":[],"core_functions":[],"conversion_path":[],"constraints":[],"non_goals":[],"data_entities":[],"success_metrics":[],"platform":null,"delivery_scope":[],"assumptions":[],"open_questions":[],"risks":[]},"open_questions":[],"newly_confirmed_fields":[],"conflicts":[],"reasoning_summary":""}',
        "EXISTING_FACTS:",
